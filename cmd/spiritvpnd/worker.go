...
const (
	...
	// ровно одно — как часто нода СВЕРЯЕТСЯ с фактическим инвентарём, и она же
	// потолок жизни расхождения, о котором никто не сообщил (§16).
	//
	...
	// пропущенная им итерация не должна отменять сверку. Больше — и мы чинили бы
	// ноду по состоянию, которое давно неверно; ровно интервал — и любое
	// расхождение темпов агента с нашим гасило бы сверку насовсем.
