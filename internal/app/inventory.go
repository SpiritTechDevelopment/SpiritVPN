...
// Причины, по которым наблюдение не годится для сверки (§10).
const (
...
//
// Непригодное наблюдение отвергается ЦЕЛИКОМ, а не частично (решение 88).
// BACKEND_TECHNICAL_SPEC.md §16 запрещает выводить удаления из усечённого инвентаря, а чиним мы полным набором
...
//
// egress_key сверх дословных «UUID/flow» BACKEND_TECHNICAL_SPEC.md §16 (решение 87): у BRIDGE он задаёт
