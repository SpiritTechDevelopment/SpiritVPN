...
// любого значения меняет контракт наблюдаемости.
...
// Причины, по которым наблюдение не годится для сверки.
const (
...
//
// Непригодное наблюдение отвергается целиком, а не частично. Выводить удаления
// из усечённого инвентаря запрещено, а починка идёт полным набором, который
// удаляет по определению. Любой триггер по непригодному наблюдению был бы
// выводом удаления в обход запрета, и половинчатых вариантов здесь нет.
...
//
// egress_key сверх пары UUID и flow: у BRIDGE он задаёт
