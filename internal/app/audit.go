...
// Типы актора. Совпадают с ролями §14, приведёнными к общей нотации; SYSTEM
...
// метаданных: §15 перечисляет «Apply/renewal» раздельно, и фильтр по колонке
...
// Исходы. Пока единственный: §15 требует аудит принятых изменений, а отклонённая
