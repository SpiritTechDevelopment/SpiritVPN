...
// application-level шифрование (§7 BACKEND_DOMAIN_AGREEMENTS.md).
//
...
// ClientUUID — секретный VLESS UUID клиентского access (§7).
//
...
// VLESS URI (§8), который расшифровывает credential на время ответа.
//
