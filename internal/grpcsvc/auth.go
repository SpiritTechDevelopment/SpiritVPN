...
// Это её главное свойство и оно важнее содержимого. Новый метод без строчки
// здесь получает PERMISSION_DENIED на первом же вызове вместо того, чтобы молча
// открыться всему миру.
//
