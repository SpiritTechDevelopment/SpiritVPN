...
//
// Значение numeric равно Int * 10^Exp, и Exp не обязан быть нулём даже у колонки
// со scale 0: PostgreSQL передаёт число группами по четыре десятичных цифры, и
// драйвер нормализует результат, отбрасывая хвостовые нули в Exp. Игнорировать Exp
// значило бы прочитать 10000 как 1; на реальных значениях квоты это ловится
// интеграционным тестом round-trip.
