...
// Канонизация снапшота и его digest.
//
// Digest считается из schema_version и отсортированного desired snapshot. В него
// НЕ входят:
//
//   - revision — иначе rollback перестал бы работать. Он выполняется
...
// а jsonb хранит разобранное значение, а не текст: PostgreSQL
...
// canonicalManifest повторяет логическую структуру манифеста, а не раскладку
