...
// IsQuotaExhausted — порог исчерпания квоты на ноде. Эффективность задаётся
...
// периода: понижение квоты ставит отметку каждой ноде, где расход достиг
